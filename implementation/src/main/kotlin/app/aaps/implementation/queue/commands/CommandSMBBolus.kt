...
class CommandSMBBolus(
    ...
    override fun execute() {
        ...
        //if (lastBolusTime != 0L && lastBolusTime + T.mins(3).msecs() > dateUtil.now()) {      // already checked in determine-basal
        ...
        if (detailedBolusInfo.deliverAtTheLatest != 0L && detailedBolusInfo.deliverAtTheLatest + T.mins(1).msecs() > System.currentTimeMillis()) {
